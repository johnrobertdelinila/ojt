            ...
            @elseif($btn_check == 'time5')
                <div class="col-xs-12 text-center">
                    <span  id="loading_div"></span>
                    <button type="submit" name="btn_time" value="time5" style="font-size:30px;padding:50px;" class="col-xs-12 btn btn-space btn-success btn-lg"><i style="font-size:30px;" class="icon icon-left mdi mdi-account-calendar"></i>&nbsp; Overtime In</button>
                </div>
            @elseif($btn_check == 'time6')
                <div class="col-xs-12 text-center">
                    <span  id="loading_div"></span>
                    <button type="submit" name="btn_time" value="time4" style="font-size:30px;padding:50px;" class="col-xs-12 btn btn-space btn-danger btn-lg"><i style="font-size:30px;" class="icon icon-left mdi mdi-power"></i>&nbsp; Overtime Out</button>
                </div>
                <div class="col-xs-12" style="margin-bottom:5px;">
                    <p style="color:red;font-size:18px;font-weight:bold;">@if(session('err')) <br/>*{{session('err')}} @endif</p>
<textarea name="accomplishment" class="form-control" style="height:150px;font-size:18px;" placeholder="Write Your Journal Here ..." minlength="30" required autofocus>
@if(isset($accomplishment)){{ $accomplishment.
'
